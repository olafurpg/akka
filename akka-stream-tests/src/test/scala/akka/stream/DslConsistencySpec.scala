...
class DslConsistencySpec extends WordSpec with Matchers {
  ...
  val ignore: _root_.scala.collection.immutable.Set[_root_.java.lang.String] =
  ...
  val graphHelpers: _root_.scala.collection.immutable.Set[_root_.java.lang.String] = Set("zipGraph", "zipWithGraph", "mergeGraph", "mergeSortedGraph", "interleaveGraph", "concatGraph", "prependGraph", "alsoToGraph", "orElseGraph")
