...
trait GenericUnmarshallers extends LowerPriorityGenericUnmarshallers {
  ...
  implicit def liftToTargetOptionUnmarshaller[A, B](
      um: Unmarshaller[A, B]): Unmarshaller[A, Option[B]] =
