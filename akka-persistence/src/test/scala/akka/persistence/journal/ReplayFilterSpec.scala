...
class ReplayFilterSpec extends AkkaSpec with ImplicitSender {
  ...
  val n1 = ReplayedMessage(
      PersistentRepr("a", 13, "p1", "", writerUuid = PersistentRepr.Undefined))
  val n2 = ReplayedMessage(
      PersistentRepr("b", 14, "p1", "", writerUuid = PersistentRepr.Undefined))
