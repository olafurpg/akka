...
object MediaType {
  ...
  def customBinary(mainType: String,
                   subType: String,
                   comp: Compressibility,
  ...
  private def renderValue(mainType: String,
                          subType: String,
  ...
  sealed abstract class Binary(val value: String,
                               val mainType: String,
                               val subType: String,
  ...
  sealed abstract class WithFixedCharset(val value: String,
                                         val mainType: String,
                                         val subType: String,
